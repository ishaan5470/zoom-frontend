  ...
  return (
    <>
      <div onClick={handleOpen} className='mt-5 flex flex-col justify-center content-stretch'>
        ...
        <button className='mx-auto w-[240px] h-[240px]  bg-white border-2 rounded-[150px]'><img src='/Images/side2.png' className='rounded-[150px] w-full h-full object-cover' alt='Pfimg' /></button>
        <div className='mx-auto text-xl mt-3'>Share Experience/Story</div>
      ...
      <Dialog open={open} fullWidth maxWidth="lg" className='backdrop-blur-sm '>
        ...
        <DialogContent>
          ...
          <div className="flex justify-center mb-5 ">
            <button onClick={handleOpen1} className='text-white border-2 px-5 py-1.5 rounded-full bg-gradient-to-r from-[#003D4D] to-[#57A7B3]'>Next</button>
          </div>
          {open1 === true ? <Upload handleClose={handleClose1} mast={handleClose} open2={open2} setOpen2={setOpen2} open={open1} /> : ""}
