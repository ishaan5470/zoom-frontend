...
export default function JobDetails({ jobType }) {
  ...
  // api fetching of country, state, city
  // useEffect(() => {
  ...
  return (
    <>
      {/* Job Details */}
      <div className=" w-screen md:mt-5  flex flex-col justify-center items-center">
        <div className="w-[90%]  md:w-[80%] lg:w-[75%]  xl:w-[60%] ">
          <span className="ml-3 font-semibold text-xl text-[#003d4d]">
            Job Details
          </span>
            ...
            <div className="flex flex-col gap-8 bg-white p-5 md:p-8 rounded-xl shadow-md shadow-gray-300 mt-3 w-full">
              ...
              <div className="flex flex-col justify-center">
                ...
                <input
                  ...
                  {...register("JobProfile", { required: "Field required" })}
                  id="JobProfile"
                />
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <div className="flex gap-3 flex-wrap">
                    {fields.map((field, index) => {
                      if (field.skill == undefined || field.skill == "") return;
                      return (
