  ...
  return (
    <>
      ...
      <div className="mt-5 w-full flex flex-col justify-center items-center mb-4">
          <div className="w-1/2">
            <span className="self-start ml-3 font-semibold text-lg text-[#003d4d]">Instant Job Details</span>
            <div className="bg-white p-5 rounded-xl shadow-md shadow-gray-300 mt-3 w-full px-10">
              <form className="flex flex-col gap-5">
                <div className="flex flex-col justify-center">
                  <label className="text-base font-semibold text-[#003d4d]" for="Business/Co-Working Space Name">Business/Co-Working Space Name</label>
                  <input className="w-full py-2 rounded-md border border-[#003d4d] px-5" placeholder="" id="Business/Co-Working Space Name" />
                </div>
                <div className="flex flex-col justify-center">
                  <label className="text-base font-semibold text-[#003d4d]" for="OppurtunityRole">Oppurtunity Role</label>
                  <input className="w-full py-2 rounded-md border border-[#003d4d] px-5" placeholder="eg. Catering Assistance" id="OppurtunityRole" />
                </div>
                <div className="flex flex-col justify-center">
                ...
                <div className="flex items-center justify-start">
                  <div className="flex flex-col justify-center w-1/2">
                    <label className="text-base font-semibold text-[#003d4d]">Required Days/Weeks</label>
                    <input className="w-[90%] py-2 rounded-md border border-[#003d4d] px-5" type="number" placeholder="eg. 2" />
                  </div>
                  <div className="flex flex-col justify-center w-1/2">
                    <label className="text-base font-semibold text-[#003d4d] invisible">Days/Weeks</label>
                ...
                <div className="flex flex-col justify-center">
                  <label className="text-base font-semibold text-[#003d4d]">Expected Amount</label>
