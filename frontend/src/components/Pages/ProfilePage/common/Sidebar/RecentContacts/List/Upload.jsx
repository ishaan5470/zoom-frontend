        ...
        <div className="flex align-middle flex-wrap justify-between w-full">
          <div className="min-w-[300px] lg:min-w-[60%]">
            <div className="flex">
              ...
              <div className="text-[2.5rem] text-center mr-10 my-3">
                Create New Post!
              </div>
            </div>
          ...
          <div className="h-[580px] min-w-[300px] bg-slate-300 lg:min-w-[40%]">
            <div className="h-[100px]  bg-yellow-200 flex items-center">
              <div className=" w-[50px] h-[50px] mx-1 object-cover bg-transparent rounded-[100px]">
                <img
            ...
            <input
              type="text"
              className="h-[5rem] w-full bg-transparent"
