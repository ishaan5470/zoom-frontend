    ...
    <>
      <button onClick={handleOpen} className=''>
        <div className="flex flex-col ">
          ...
          <div className='font-thin text-[14px] leading-3 ml-1 mr-auto'>12k</div>
        </div>
      </button>
      <Dialog open={open} fullWidth maxWidth="sm" className='backdrop-blur-sm'>
        ...
        <div className="flex items-center mt-1 px-6">
          ...
          <h1 className='text-[1.3rem] ml-2'> <span className='text-[18px] font-light italic mr-1'>12k</span> Appreciation</h1>
        </div>
        <DialogContent>
          <DialogContentText>
          </DialogContentText>
